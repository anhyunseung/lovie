...
(function() {
  ...
  Config = (function() {
    function Config(options) {
      ...
      this.attachedBody = this._attachedBody(options.attachedBody);
    ...
    Config.prototype._attachedBody = function(val) {
    	return ko.observable(val || false);
    };
    ...
    Config.prototype._parentElement = function(val) {
      return $(val || (this.attachedBody() ? 'body' : '.filter_period'));
    };
  ...
  DateRangePickerView = (function() {
    ...
    DateRangePickerView.prototype.inputFocus = function() {
      return this.expanded(window.innerWidth >= 880);
    };
