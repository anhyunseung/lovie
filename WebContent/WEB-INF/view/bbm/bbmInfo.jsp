...
<link rel="shortcut icon" href="http://localhost:8080/bbm/bbmInfo.do/../../img/common/icon.ico" type="image/x-icon" />
...
<div>
	...
	<form action="/bbm/commentreg.do" onsubmit="return doSubmit2(this);" method="post">
					<div class="infot">
   <table>
   <tr>
   <td>
