...
function doOnload(){
   ...
   if ("<%=access%>" == "1") {
			...
			location.href = "/inquiry/inquiryInfo.do?inq_seq=<%=CmmUtil.nvl(request.getParameter("inq_seq"))%>";
		}
	}
...
<form name="f" method="post" action="/inquiry/inquiryUpdate.do" style="height:100%;">
     ...
     <div class="rightmenu" align="left">
		<div class="writemenu">
            ...
            <input type="text" autocomplete="off" name="title" maxlength="40"
               style="width: 500px; height: 24px;"value="<%=CmmUtil.nvl(rDTO.getTitle())%>" /></td>
               </div>
				</div>
            ...
            <div class="tabledown" align="right">
				...
				<a style="cursor: pointer;" onclick="doInfo('<%=CmmUtil.nvl(rDTO.getinq_seq())%>');">
