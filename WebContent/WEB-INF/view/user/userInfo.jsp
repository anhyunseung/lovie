...
<link rel="shortcut icon" href="http://localhost:8080/user/userInfo.do"/../../img/common/icon.ico" type="image/x-icon" />
	...
	<div class="rightmenu" align="left">
		<div class="writemenu">
			...
			<div class="tableborder">
				...
				<img src="../img/button/out.png"
							onmouseover="this.src='../img/button/out2.png'"
							onmouseout="this.src='../img/button/out.png'" />
				</a>
				<a style="cursor: pointer;" onclick="doEdit();">
				<img src="../img/button/rewri.png"
							onmouseover="this.src='../img/button/rewri2.png'"
							onmouseout="this.src='../img/button/rewri.png'" />
				</a>
				<a style="cursor: pointer;" onclick="doTop();">
