...
String SS_USER_ID = CmmUtil.nvl((String)session.getAttribute("USER_IDF"));
session.setAttribute("USER_IDF", "");
%>
	...
	<div class="maindiv" align="center">
		<div class="logindiv">
			<div class="joinfont">
				...
				<input type="button" class="sign" onclick="Close_Event();" value="확인"/>
				</div>
		</div>
	</div>
</body>
